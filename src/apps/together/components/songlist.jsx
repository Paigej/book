MyComponents.Song = React.createClass({
  ...
  render: function() {
   ...
   if (this.props.user) {
     return (
     	<li>
     		<div className="collapsible-header white-text blue-grey darken-3">{ songName }</div>
     		<div className="collapsible-body white-text"><p>Artist: { artist }<br/>Album: { album }<br/>Votes: { voteCount }&nbsp; &nbsp;
    ...
    return (
      <li>
        <div className="collapsible-header white-text blue-grey darken-3">{ songName }</div>
        <div className="collapsible-body white-text"><p>Artist: { artist }<br/>Album: { album }<br/>Votes: { voteCount }</p></div>
      </li>
     );
   }
 }
      ...
      <div>
        <div className="card blue-grey darken-4">
          <div className="card-content">
            <ul className="tabs blue-grey darken-3">
